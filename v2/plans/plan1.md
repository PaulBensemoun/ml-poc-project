...
Toute la refonte dépend de la structure réelle des fichiers Coveo. Avant d'écrire le pipeline, il faut disposer localement des fichiers et vérifier qu'ils correspondent aux hypothèses des documents `v2/context/`.
...
- `v2/data/coveo/raw/`
- `v2/context/V2_DATASET_DECISION.md`
- `v2/context/DATA_STRATEGY.md`
- `README.md` plus tard

## Livrables

- Dataset Coveo disponible localement.
- Structure `v2/data/coveo/raw/` prête.
