...
Si la structure multipage Streamlit pose problème, utiliser une navigation via sidebar dans `src/app.py`.
...
- vraie structure `src/pages/` ;
- ou sidebar dans `src/app.py` si plus compatible avec le template existant.
